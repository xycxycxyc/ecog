...
class SystemIntro(QWidget):
    ...
    def setupUI(self):
        ...
        html = '''
            ...
            <font size = 4><b>1.功能区边界定位图:</b></font>主要技术路线是采用机器学习的方法。对输入的ECoG数据进行预处理，\
            特征提取，接着使用聚类算法识别出不同功能区属性的电极，并画出相应的等高线图，得到功能区边界定位图<br/><br/>
            <font size = 4><b>2.功能区属性定位图:</b></font>主要技术路线是根据经典的解剖学定位图，结合和脑皮质的主要沟回确\
            定功能区的在脑皮质的相对位置，接着使用图像处理的方法标记出不同属性的功能区边界。得到功能区属性定位图。<br/><br/>\
            <font size = 4><b>3.功能区地形图:</b></font>主要技术路线是使用前两步得到的边界定位图和属性定位图合成最终的功能\
            区地形图。<br/><br/></font>\
